...
public class TriangleTest {
    ...
    public void testTriangle() {
        ...
        // Testujemy boki trójkąta
        assertEquals(3.0, triangle.getSideA());
        assertEquals(4.0, triangle.getSideB());
        assertEquals(5.0, triangle.getSideC());

        // Testujemy pole
        assertEquals(6.0, triangle.getArea(), 0.01); // Możesz zmienić tolerancję, jeśli dokładność jest inna
    ...
    public void testTriangleDraw() {
        ...
        // Zakładając, że masz metodę draw() w klasie Triangle
        triangle.draw();
    }
